...
public class PunchlineFragment extends Fragment {
    ...
    private static final String ARG_PARAM1 = "arg_punchline";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mPunchLine = getArguments().getString(ARG_PARAM1);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView tv = view.findViewById(R.id.tv_punchline);
        if (mPunchLine != null){
            tv.setText(mPunchLine);
        } else {
            tv.setText("Error");
        }
